...
class CocktailDetailPage extends StatelessWidget {
          ...
          children: [
            Stack(children: [
              Container(
                  ...
                  child:
                      Image(image: AssetImage('assets/images/cocktail_7.png'))),
              SafeArea(
                      ...
                      (index) => Container(
                          ...
                          child: (() {
                            if (index < 3)
                              return Image(
                                image:
                                    AssetImage('assets/images/star_active.png'),
                              );
                            else
                              return Image(
                                image: AssetImage(
  ...
  Widget _tagWidget(String text) => Container(
  ...
  Widget _cocktailParamWidget(String text) => Container(
        margin: EdgeInsets.only(top: 5, bottom: 5),
        child: Text(
          text,
          style: TextStyle(
  ...
  Widget _ingredientWidget(String name, String value) => Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Text(
          value,
          style: TextStyle(
              fontFamily: 'SanFrancisco', fontSize: 14, color: Colors.white),
        ),
      ]));
